...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startAnimationButton.setText(R.string.start_game);
        ...
        private final View.OnClickListener startClickedListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ViewGroup contentView = (ViewGroup) ((ViewGroup) findViewById(android.R.id.content))
                        .getChildAt(0);

                // make the bug view
                ImageView bugView = new ImageView(MainActivity.this);
                bugView.setImageResource(R.drawable.bug_animation);
                //bugView.setBackgroundResource(R.drawable.bug_animation);
                bugView.setOnTouchListener((v, event) -> {
    ...
    private final ValueAnimator.AnimatorUpdateListener animatorUpdated =
